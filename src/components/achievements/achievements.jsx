        ...
        <ul className={styles.achievementsItems}>
          ...
          <li className={styles.achievementsItem}>
            ...
            <div className={styles.achievementsItemText}>
              ...
              <p>
                Achieved the Codeforces Specialist title with consistent performance in competitive programming contests. With Constant dedication and daily practise, I have solved over 250+ problems and my next goal is to reach the Expert level.
              </p>
            </div>
          </li>
          <li className={styles.achievementsItem}>
